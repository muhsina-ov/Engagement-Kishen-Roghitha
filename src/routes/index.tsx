...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Jai Kishen & Roghitha | Engagement Invitation - 17 Sep 2026" },
      {
        name: "description",
        content:
          "Celebrate the engagement of Jai Kishen & Roghitha on Thursday, 17 September 2026, 10:30 AM at Mogappair West, Chennai. Event timings, venue directions and calendar invite.",
      },
      { property: "og:title", content: "Jai Kishen & Roghitha | Engagement Invitation" },
      {
        property: "og:description",
        content:
          "You are cordially invited to celebrate the engagement ceremony of Jai Kishen & Roghitha on 17 September 2026 in Chennai.",
      },
      ...
      { name: "twitter:title", content: "Jai Kishen & Roghitha | Engagement Invitation" },
      {
        ...
        content:
          "Celebrate the engagement ceremony of Jai Kishen & Roghitha on 17 September 2026.",
      },
